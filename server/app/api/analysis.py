...
```deepimage-graph
{
  "type": "geometry|function|mixed",
  "title": "图形标题",
  "elements": [
    {"kind": "circle", "label": "O", "cx": 0, "cy": 0, "r": 1},
    {"kind": "point", "label": "A", "x": 1, "y": 0},
    {"kind": "point", "label": "P", "x": 0.6, "y": 0.8},
    {"kind": "line", "label": "OA", "from": "O", "to": "A"},
    {"kind": "line", "label": "OP", "from": "O", "to": "P"},
    {"kind": "line", "label": "PM", "from": "P", "to": "M", "style": "dashed"},
    {"kind": "right_angle", "at": "M", "lines": ["PM", "OA"]},
    {"kind": "angle", "label": "x", "at": "O", "from": "A", "to": "P"},
    {"kind": "curve", "label": "A", "shape": "single_peak", "peak_y": 1, "zeros": [0, 1]},
    {"kind": "curve", "label": "B", "shape": "double_peak", "peak_y": 0.5, "zeros": [0, 0.5, 1]},
    {"kind": "curve", "label": "C", "shape": "double_peak", "peak_y": 1, "zeros": [0, 0.5, 1]},
    {"kind": "curve", "label": "D", "shape": "single_peak", "peak_y": 1, "zeros": [0, 1]}
  ]
}
```
